...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RYA Business Group" },
      { name: "description", content: "Révélez votre beauté naturelle avec les laits corporels haut de gamme RYA Business Group." },
      { name: "author", content: "RYA Business Group" },
      { property: "og:title", content: "RYA Business Group" },
      { property: "og:description", content: "Révélez votre beauté naturelle avec les laits corporels haut de gamme RYA Business Group." },
